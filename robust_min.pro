...
; 
; NOTE that robust_max has been modified with enhanced features, haven't implemented this for robust_min yet.
; But one can call robust_max and use the min keyword with robust_max.
;
; CALLING SEQUENCE:
